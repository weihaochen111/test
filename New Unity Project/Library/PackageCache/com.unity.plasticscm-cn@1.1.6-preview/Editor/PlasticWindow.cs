...
namespace Unity.PlasticSCM.Editor
{
        ...
        CreateWorkspaceView.ICreateWorkspaceListener
    {
        ...
        void OnEnable()
        {
            ...
            EditorApplication.update += IncomingChangesFromMainNotification.Execute;
        }
            ...
            IIncomingChangesNotificationPanel incomingChangesNotificationPanel)
        {
            ...
            if (!incomingChangesNotificationPanel.IsVisible)
            {
                IncomingChangesFromMainNotification.DrawIncomingChangesNotification();
            }
